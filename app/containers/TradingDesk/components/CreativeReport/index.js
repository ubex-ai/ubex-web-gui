...
class CreativeReport extends React.Component {
	constructor(props) {
		...
		this.state = {
			...
			reportData: [{ date: '12-04-2019', impressions: '5000', clicks: '500', CTR: '5%', winrate: '10%', spend: '$200', CPM: '$12' }],
			optionsSelect: [
			...
			<div>
							...
							<Col md={12} sm={12} xl={5} lg={6}>
								<div className="page-title">
									<div className="float-left">
										<h1 className="title">
											<FormattedMessage {...messages.creativeReports} /> (soon)
										</h1>
									</div>
								</div>
							</Col>
				...
				<Row className="row margin-0">
					<Col className="col-md-12">
											...
											<Row>
												...
												<Col xl={4}>
													<h6 style={{ fontSize: '16px', paddingTop: '14px' }}>
														from {moment().format('DD-MM-YYYY')} to{' '}
														{moment()
															.add(7, 'days')
															.format('DD-MM-YYYY')}
													</h6>
						...
						<AppCard>
							<AppTable columns={this.state.reportColumns} data={this.state.reportData} pagination exportTable search/>
						</AppCard>
					</Col>
				</Row>
			</div>
...
export default compose(withConnect)(CreativeReport);
