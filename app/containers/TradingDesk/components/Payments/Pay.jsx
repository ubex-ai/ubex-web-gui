						...
						<Col xs={12} md={12}>
							...
							<Row>
								<Col md={12} style={{ paddingLeft: '5px', paddingRight: '5px' }}>
									<AppCard>
										<h2 className="title" style={{textAlign: 'center'}}><FormattedMessage {...messages.getBenefit} /></h2>
										<Row className="pay-benefits">
											<Col md={3} className="mt-5">
												<div className="number">1</div>
												<span><FormattedMessage {...messages.bonus5} /></span>
											</Col>
											<Col md={3} className="mt-5">
												<div className="number">2</div>
												<span><FormattedMessage {...messages.noCommission} /></span>
											</Col>
											<Col md={3} className="mt-5">
												<div className="number">3</div>
												<span><FormattedMessage {...messages.crossBorderPayments} /></span>
											</Col>
											<Col md={3} className="mt-5">
												<div className="number">4</div>
												<span><FormattedMessage {...messages.deferredPayment} /></span>
											</Col>
										</Row>
									</AppCard>
								</Col>
