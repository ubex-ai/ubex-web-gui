...
export const SET_LANGUAGE_LOADING = 'app/Dashboard/SET_LANGUAGE_LOADING';
...
export const CATEGORYV1_COLLECTION_NAME = 'categoriesV1';
export const LANGUAGE_COLLECTION_NAME = 'languages';
export const SET_UBEX_POPOVER = 'ubexPopover';
export const SET_PAYMENT_MODAL = 'paymentModal';
...
export const categoriesActionsV1 = makeListActions(CATEGORYV1_COLLECTION_NAME);
