					...
					<div className="popoverContent">
						{this.props.popoverHeader && (
							<div className="popoverHeader">
								{typeof this.props.popoverHeader === 'object' ? <FormattedMessage {...this.props.popoverHeader} /> : <FormattedMessage id={this.props.popoverHeader} />}
							</div>
						)}
						{this.props.popoverBody && (
							<div className="popoverBody">
								{typeof this.props.popoverHeader === 'object' ? <FormattedMessage {...this.props.popoverBody} /> : <FormattedMessage id={this.props.popoverBody} />}
							</div>
						)}
					</div>
				</Popover>
