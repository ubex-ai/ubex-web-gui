...
module.exports = require('./webpack.base.babel')({
	...
	plugins: [
		...
		new webpack.DefinePlugin({
			PASSPORT_URL: JSON.stringify('https://passport.dev.ubex.io'),
			API_URL: JSON.stringify('https://desk.dev.ubex.io'),
			STATISTIC_URL: JSON.stringify('https://desk.dev.ubex.io/stats'),
			MINING_URL: JSON.stringify('https://mining.ubex.com'),
			PUBLISHER_URL: JSON.stringify('https://network.ubex.com'),
			TRADING_DESK_URL: JSON.stringify('https://desk.dev.ubex.io'),
			CRYPTO_MODE: true,
